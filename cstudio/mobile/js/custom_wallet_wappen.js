...
$(document).ready(function(){
	...
	function wappen_click_ev(wappen_status, wappen_index){//### 2.와펜 클릭 이벤트
		...
		var wappen_index3 = Number(wappen_index)+5;
		var wappen_index4 = Number(wappen_index)+6;

		var wappen_index5 = Number(wappen_index)-6;//선택자 over group1 (왼쪽 상단)
		var wappen_index6 = Number(wappen_index)-5;
		var wappen_index7 = Number(wappen_index)-4;
		var wappen_index8 = Number(wappen_index)-1;
		var wappen_index9 = Number(wappen_index)+4;

		var wappen_index10 = Number(wappen_index)-3;//선택자 over group1 (오른쪽 하단)
		var wappen_index11 = Number(wappen_index)+2;
		var wappen_index12 = Number(wappen_index)+7;
		var wappen_index13 = Number(wappen_index)+9;
		var wappen_index14 = Number(wappen_index)+10;
		var wappen_index15 = Number(wappen_index)+11;
		var wappen_index16 = Number(wappen_index)+12;
		...
		function small_big_chk_ev(chk1,chk2,chk3,chk4){//big체크 big속성 제거 event
			...
			if(select_num.indexOf(chk4) != -1){//중첩num array 삭제 - 기본 4
				...
				$('#wappen_svg_in'+chk1).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});//big_sel 디자인 제거 1 
				$('#wappen_svg_in'+chk2).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});//big_sel 디자인 제거 2 
				$('#wappen_svg_in'+chk3).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});//big_sel 디자인 제거 3 
				$('#wappen_svg_in'+chk4).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});//big_sel 디자인 제거 4 
				...
				$('#wappen_svg_in_side'+chk1).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});//big_sel 디자인 제거 1 
				$('#wappen_svg_in_side'+chk2).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});//big_sel 디자인 제거 2 
				$('#wappen_svg_in_side'+chk3).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});//big_sel 디자인 제거 3 
				$('#wappen_svg_in_side'+chk4).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});//big_sel 디자인 제거 4 
		...
		function big_over_chk_ev(chk1,chk2,chk3,chk4){//big충돌시 삭제 event
			...
			$("#wappen_svg_in"+chk1).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});////big_선택 체크
			$("#wappen_svg_in"+chk2).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});
			$("#wappen_svg_in"+chk3).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});
			$("#wappen_svg_in"+chk4).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});
			$('#wappen_svg_in'+chk1).css("display","none");
			$('#wappen_svg_in'+chk2).css("display","none");
			$('#wappen_svg_in'+chk3).css("display","none");
			$('#wappen_svg_in'+chk4).css("display","none");
			...
			/*20151027 side 와펜 추가 start*/
			$("#wappen_svg_in_side"+chk1).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});////big_선택 체크
			$("#wappen_svg_in_side"+chk2).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});
			$("#wappen_svg_in_side"+chk3).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});
			$("#wappen_svg_in_side"+chk4).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});
			$('#wappen_svg_in_side'+chk1).css("display","none");
			$('#wappen_svg_in_side'+chk2).css("display","none");
			$('#wappen_svg_in_side'+chk3).css("display","none");
			$('#wappen_svg_in_side'+chk4).css("display","none");
			...
			if(wappen_status=="small"){//##2-1. small 일때
				...
				$('#wappen_svg_in'+wappen_index1).attr({"xlink:href": wappen_url, "width":"110px", "height":"141px"});

				/*20151027 side 와펜 추가 start*/
				$('#wappen_svg_in_side'+wappen_index1).css("display","block");//small design 처리
				$('#wappen_svg_in_side'+wappen_index1).attr({"xlink:href": wappen_url, "width":"110px", "height":"141px"});
				/*20151027 side 와펜 추가 end*/
				...
				$('#wappen_svg_in'+wappen_index1).attr({"xlink:href": wappen_url, "width":"220px", "height":"282px"});//design 처리
				$('#wappen_svg_in'+wappen_index2).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});
				$('#wappen_svg_in'+wappen_index3).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});
				$('#wappen_svg_in'+wappen_index4).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});
				...
				/*20151027 side 와펜 추가 start*/
				$('#wappen_svg_in_side'+wappen_index1).attr({"xlink:href": wappen_url, "width":"220px", "height":"282px"});//design 처리
				$('#wappen_svg_in_side'+wappen_index2).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});
				$('#wappen_svg_in_side'+wappen_index3).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});
				$('#wappen_svg_in_side'+wappen_index4).attr({"xlink:href": wappen_url_none, "width":"110px", "height":"141px"});
