...
$(document).ready(function(){
	...
	$("#sort_wrap_wappen1 .select_change, #sort_wrap_wappen2 .select_change, #wappen_del").click(function(){//### 1.사이즈 선택, 주소값, 제외 영역 처리

		wappen_url = img_url + "wappen/wappen_set_"+wappen_status+wappen_num+".png"; //와펜 이미지 주소 생성

		$("#sort_wrap_wappen1 .select_change, #sort_wrap_wappen2 .select_change, #wappen_del").removeClass("on");
		$(this).addClass("on");

		if($(this).find("img").hasClass("soldout")){//와펜클릭시 품절 체크
			soldout_chk = true;
		}else{
			soldout_chk = false;
		}
		...
		if(wappen_status=="small"){//small 사이즈
			...
			//20151217 추가: start
			for(var i in delete_small_rec) {
				$("#wappen_svg"+delete_small_rec[i]).removeClass("off_sel");
			}
			//20151217 추가: end
			for(var i in delete_big_rec) {
	...
	function wappen_click_ev(wappen_status, wappen_index){//### 2.와펜 클릭 이벤트 20160120

		var wappen_index1 = wappen_index;//선택자 big 영역
		var wappen_index2 = Number(wappen_index)+1;
		var wappen_index3 = Number(wappen_index)+4;
		var wappen_index4 = Number(wappen_index)+5;

		var wappen_index5 = Number(wappen_index)-5;//선택자 over group1 (왼쪽 상단)
		var wappen_index6 = Number(wappen_index)-4;
		var wappen_index7 = Number(wappen_index)-3;
		var wappen_index8 = Number(wappen_index)-1;
		var wappen_index9 = Number(wappen_index)+3;

		var wappen_index10 = Number(wappen_index)-2;//선택자 over group1 (오른쪽 하단)
		var wappen_index11 = Number(wappen_index)+2;
		var wappen_index12 = Number(wappen_index)+6;
		var wappen_index13 = Number(wappen_index)+7;
		var wappen_index14 = Number(wappen_index)+8;
		var wappen_index15 = Number(wappen_index)+9;
		var wappen_index16 = Number(wappen_index)+10;
		...
		function small_big_chk_ev(chk1,chk2,chk3,chk4){//big체크 big속성 제거 event
			...
			if(select_num.indexOf(chk4) != -1){//중첩num array 삭제 - 기본 4
				...
				$('#wappen_svg_in'+chk1).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});//big_sel 디자인 제거 1 
				$('#wappen_svg_in'+chk2).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});//big_sel 디자인 제거 2 
				$('#wappen_svg_in'+chk3).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});//big_sel 디자인 제거 3 
				$('#wappen_svg_in'+chk4).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});//big_sel 디자인 제거 4 
				...
				$('#wappen_svg_in_side'+chk1).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});//big_sel 디자인 제거 1 
				$('#wappen_svg_in_side'+chk2).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});//big_sel 디자인 제거 2 
				$('#wappen_svg_in_side'+chk3).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});//big_sel 디자인 제거 3 
				$('#wappen_svg_in_side'+chk4).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});//big_sel 디자인 제거 4 
		...
		function big_over_chk_ev(chk1,chk2,chk3,chk4){//big충돌시 삭제 event
			...
			$("#wappen_svg_in"+chk1).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});////big_선택 체크
			$("#wappen_svg_in"+chk2).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});
			$("#wappen_svg_in"+chk3).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});
			$("#wappen_svg_in"+chk4).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});
			$('#wappen_svg_in'+chk1).css("display","none");
			$('#wappen_svg_in'+chk2).css("display","none");
			$('#wappen_svg_in'+chk3).css("display","none");
			$('#wappen_svg_in'+chk4).css("display","none");
			...
			/*20151027 side 와펜 추가 start*/
			$("#wappen_svg_in_side"+chk1).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});////big_선택 체크
			$("#wappen_svg_in_side"+chk2).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});
			$("#wappen_svg_in_side"+chk3).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});
			$("#wappen_svg_in_side"+chk4).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});
			$('#wappen_svg_in_side'+chk1).css("display","none");
			$('#wappen_svg_in_side'+chk2).css("display","none");
			$('#wappen_svg_in_side'+chk3).css("display","none");
			$('#wappen_svg_in_side'+chk4).css("display","none");
			...
			if(wappen_status=="small"){//##2-1. small 일때
				...
				$('#wappen_svg_in'+wappen_index1).attr({"xlink:href": wappen_url, "width":"145px", "height":"165px"});

				/*20151027 side 와펜 추가 start*/
				$('#wappen_svg_in_side'+wappen_index1).css("display","block");//small design 처리
				$('#wappen_svg_in_side'+wappen_index1).attr({"xlink:href": wappen_url, "width":"145px", "height":"165px"});
				/*20151027 side 와펜 추가 end*/
				...
				if(soldout_chk == true){//품절체크 20150915
					...
					$('.toolbox'+wappen_index1).css('top', $('#wappen_svg_in'+wappen_index1).offset().top - 130);
				...
				$('#wappen_svg_in'+wappen_index1).attr({"xlink:href": wappen_url, "width":"290px", "height":"330px"});//design 처리
				$('#wappen_svg_in'+wappen_index2).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});
				$('#wappen_svg_in'+wappen_index3).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});
				$('#wappen_svg_in'+wappen_index4).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});
				...
				/*20151027 side 와펜 추가 start*/
				$('#wappen_svg_in_side'+wappen_index1).attr({"xlink:href": wappen_url, "width":"290px", "height":"330px"});//design 처리
				$('#wappen_svg_in_side'+wappen_index2).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});
				$('#wappen_svg_in_side'+wappen_index3).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});
				$('#wappen_svg_in_side'+wappen_index4).attr({"xlink:href": wappen_url_none, "width":"145px", "height":"165px"});
				...
				if(soldout_chk == true){//품절체크 20150915
					...
					$('#wappen_svg_in_side'+wappen_index1).attr("opacity","0.3");/*20151027 추가*/
					$("#custom_layout").append('<div class="custom_tooltip toolbox'+wappen_index1+'"><div class="tipBody">해당옵션은 품절되었습니다.<br/> 다른 옵션을 선택해주세요.</div></div>');  
					$('.toolbox'+wappen_index1).css('top', $('#wappen_svg_in'+wappen_index1).offset().top - 115);
					$('.toolbox'+wappen_index1).css('left', $('#wappen_svg_in'+wappen_index1).offset().left - 25);
					var custom_tooltip = window.setInterval(function(){
						window.clearInterval(custom_tooltip);
						$('.toolbox'+wappen_index1).fadeOut("fast",function(){
							$('.toolbox'+wappen_index1).remove();
