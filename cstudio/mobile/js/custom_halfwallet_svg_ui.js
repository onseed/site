...
//			$('#front_svg,#back_svg,#top_svg').css("display","none");
...
function bag_color_Img_url_make(num){//color 처리 ev
	if(custom_status == "color_base"){
		...
		$("#sort_color_tab .tab01, #sort_color_tab .tab03").css("backgroundImage","url("+img_url+"color/halfwallet_color_small"+bag_base+".jpg)"); //20160126 추가
		if(bag_base == 0){
		...
		bag_front = num; //컬러값 front 선택
		$("#sort_color_tab .tab03").css("backgroundImage","url("+img_url+"color/halfwallet_color_small"+bag_front+".jpg)"); //20160126 추가
		if(bag_front == 0){
		...
		$("#sort_color_tab .tab04").css("backgroundImage","url("+img_url+"color/halfwallet_color_small"+bag_handle+".jpg)"); //20160126 추가
		if(bag_handle == 0){
