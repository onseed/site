...
$(document).ready(function(){
	...
	$.when(svg_front_load, svg_side_load, svg_back_load, svg_top_load).then(
		function(data1, data2, data3, data4){//load success
			...
			$("#sort_color_tab .tab01").css("backgroundImage","url("+img_url+"color/jackie_color_small0.jpg)");
...
function bag_color_Img_url_make(num){//color 처리 ev
	if(custom_status == "color_base"){
		...
		$("#sort_color_tab .tab01, #sort_color_tab .tab03").css("backgroundImage","url("+img_url+"color/jackie_color_small"+bag_base+".jpg)");
		if(bag_base == 0){
		...
		bag_front = num; //컬러값 front 선택
		$("#sort_color_tab .tab03").css("backgroundImage","url("+img_url+"color/jackie_color_small"+bag_front+".jpg)");
		if(bag_front == 0){
		...
		$("#sort_color_tab .tab04").css("backgroundImage","url("+img_url+"color/jackie_color_small"+bag_handle+".jpg)");
		if(bag_handle == 0){
