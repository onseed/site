...
var front_bag_id_url //20160105 id 값 추가
...
function check_skin_ev(){//저장된 정보
	...
	"strab_spec="+ strab_spec + " : " + //20160105 추가		
	"id_spec="+ id_spec	 //20160105 추가		
	);
...
function load_skin(){//##커스텀 스킨 로드 20150915 수정처리
	...
	front_bag_id_url = base_url+"amy"+"_front_base"+ bag_front+"_"+bag_front_pattern +".jpg"; //id용 이미지를 불러옴 20160105
	$("#svg_front_id_img").attr("xlink:href", front_bag_id_url);
	$("#unit01_id").attr("fill","url(#svg_front_id)");//ID 영역 20160105
