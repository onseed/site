...
$(window).load(function(){
	...
	var side_more_ani = window.setInterval(function(){
...
function bag_color_Img_url_make(num){//color 처리 ev
	if(custom_status == "color_base"){
		...
		$("#sort_color_tab .tab01, #sort_color_tab .tab03").css("backgroundImage","url("+img_url+"color/amy_color_small"+bag_base+".jpg)"); //20150918 추가
		if(bag_base == 0){
